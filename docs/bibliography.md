...
- **Clearance-weighted A* (B41) is a deliberate departure from prior art.** The repository's prior-art research (`_bmad-output/planning-artifacts/research/technical-regression-safe-routing-improvements-research-2026-04-05.md`) explicitly notes that libavoid does not use an inverse-distance clearance penalty. Present clearance-weighting as a project contribution, not a citation-grounded inheritance.
